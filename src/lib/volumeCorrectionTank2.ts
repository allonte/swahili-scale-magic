// Tank 2 volume correction factors table data extracted from calibration document
// Temperature ranges from 0°C to 30.0°C, Density ranges from 0.500 to 0.590 kg/L
...
const volumeCorrectionTable: CorrectionData[] = [
  ...
  { temperature: 29.0, factors: { "0.500": 0.972, "0.510": 0.973, "0.520": 0.975, "0.530": 0.975, "0.540": 0.977, "0.550": 0.979, "0.560": 0.979, "0.570": 0.980, "0.580": 0.981, "0.590": 0.982 } },
  { temperature: 29.5, factors: { "0.500": 0.970, "0.510": 0.972, "0.520": 0.974, "0.530": 0.974, "0.540": 0.976, "0.550": 0.977, "0.560": 0.978, "0.570": 0.979, "0.580": 0.980, "0.590": 0.981 } },
  { temperature: 30.0, factors: { "0.500": 0.969, "0.510": 0.970, "0.520": 0.972, "0.530": 0.973, "0.540": 0.974, "0.550": 0.976, "0.560": 0.977, "0.570": 0.978, "0.580": 0.978, "0.590": 0.980 } }
];
...
export function getVolumeCorrectionFactor(density: number, temperature: number): number {
  ...
  const clampedTemperature = Math.max(0, Math.min(30.0, temperature));
